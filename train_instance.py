...
from instanceSegmentation.infer import CONNECTION_PARTS, connection2pafs
...
if __name__ == "__main__":
    ...
    while epoch < args.epoch:
        ...
        for i0, (image_ts, mask_ts, paf_ts, results) in enumerate(trainloader):
            ...
            input_ts = torch.cat([image_ts, paf_ts], dim=1)
            ...
            if i0 % args.val_iter == 0:
                with torch.no_grad():
                    ...
                    for j0, (vimage_ts, vmask_ts, vpaf_ts, vresults) in enumerate(valloader):
                        ...
                        vinput_ts = torch.cat([image_ts, paf_ts], dim=1)
                    ...
                    if show_img_tag:
                        ...
                        train_show_img = np.concatenate([image, mask3, paf_show, mix, outmask_show], axis=1)

                        val_show_img = np.concatenate([vimage, vmask3, vpaf_show, vmix, voutmask_show], axis=1)
