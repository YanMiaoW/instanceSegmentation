            ...
            if i0 % args.val_iter == 0:
                with torch.no_grad():
                    ...
                    if show_img_tag:
                        ...
                        train_show_img = np.concatenate([image, mask3, heatmap_show, mix, outmask_show], axis=1)

                        val_show_img = np.concatenate([vimage, vmask3, vheatmap_show, vmix, voutmask_show], axis=1)
