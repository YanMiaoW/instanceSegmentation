...
from instanceSegmentation.infer import get_instance_model, infer_instance, connection2pafs
        ...
        for j0, (contour, parent) in enumerate(zip(contours, hierarchy[0, :, 3])):
            ...
            if len(faces) <= 1:
                ...
                for keypoints in poses:
                    ...
                    instance_mask = infer_instance(instance_model, image, segment_mask, pafs, rect=rect, bolder=16)
